...
| `DEVICE_TREE_URL` | Device address | https://github.com/dazui-py/A145R-OFox |
| `DEVICE_TREE_BRANCH` | Device branch | fox_12.1 |
| `DEVICE_PATH` | Device location | device/samsung/a14m |
| `COMMON_TREE_URL` | Common tree address |  |
| `COMMON_PATH` | Common tree location |  |
| `DEVICE_NAME` | Model name | a14m |
| `MAKEFILE_NAME` | Makefile name | twrp_a14m |
